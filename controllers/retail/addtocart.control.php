 ...
 */
 ...
 function run()
 {
    ...
    // Si se da clic al boton del precio (POST) y se recibe un codigo de producto en la URL (GET). AMBOS METODOS EN UNO
    if($_SERVER["REQUEST_METHOD"] === "POST" && isset($_GET['codprd']))
    {
        ...
        //En controllers/mw/verificar.mw.php esta la funcion para saber si esta logueado o no. Asi sabemos en que carretilla agregar el producto
        if(mw_estaLogueado())
        {
            //Agregar Carretilla Autenticada
        ...
        else
        {
            ...
            $resultArray['msg'] = "Agregando a Carretilla Anónima";
